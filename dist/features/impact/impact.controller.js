...
let ImpactController = class ImpactController {
    ...
    getLedger(from, to, ngoId, limit = 50, offset = 0) {
...
__decorate([
    ...
    __param(2, (0, common_1.Query)('ngo_id')),
    __param(3, (0, common_1.Query)('limit')),
    __param(4, (0, common_1.Query)('offset')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String, Object, Object]),
    __metadata("design:returntype", void 0)
], ImpactController.prototype, "getLedger", null);
__decorate([
    (0, common_1.Post)('ledger/export'),
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt')),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], ImpactController.prototype, "exportLedger", null);
